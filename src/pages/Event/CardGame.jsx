...
import cardBack from '../../assets/webpImages/images/eventPage/cardBack.webp'
import card1 from '../../assets/webpImages/images/eventPage/card1.webp'
import card2 from '../../assets/webpImages/images/eventPage/card2.webp'
import card3 from '../../assets/webpImages/images/eventPage/card3.webp'
import card4 from '../../assets/webpImages/images/eventPage/card4.webp'
import card5 from '../../assets/webpImages/images/eventPage/card5.webp'
import card6 from '../../assets/webpImages/images/eventPage/card6.webp'
      ...
      {result && (
        <div className={styles.modalBackdrop}>
          <section className={styles.resultModal} role="dialog" aria-modal="true" aria-labelledby="result-title">
            ...
            <h2 id="result-title">
              {nickname ? `${nickname}나으리가` : '나으리가'} 맞추신 카드는 {result.pairCount}쌍입니다!
            </h2>
