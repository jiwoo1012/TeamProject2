...
const BrandIntro = () => {
  ...
  return (
    <main className={styles.page}>
      ...
      <p className={styles.scrollGuide} aria-hidden="true">
        <span>아래로</span>
        <i />
      </p>
    </section>
    ...
    <section className={styles.reason} aria-labelledby="traditional-liquor-title">
      ...
      <ol className={styles.reasonList}>
        <li>
          <span className={styles.reasonMarker}>01</span>
          <strong>지역의 풍경</strong>
          <p>술이 태어난 고장의 계절과 풍토를 한 잔 안에서 만납니다.</p>
        </li>
        <li>
          <span className={styles.reasonMarker}>02</span>
          <strong>우리의 재료</strong>
          <p>쌀과 과실, 꽃과 약초가 가진 고유한 맛과 향을 발견합니다.</p>
        </li>
        <li>
          <span className={styles.reasonMarker}>03</span>
          <strong>빚는 사람</strong>
    ...
    <section className={styles.closing} aria-labelledby="closing-title">
      <div className={styles.closingInner}>
        <div className={styles.closingIntro}>
          ...
          <Link className={styles.shopLink} to="/shop">상품 둘러보기</Link>
        </div>
